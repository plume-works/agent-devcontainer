...
- Release binaries are pinned by version and checksum, the catalog and validator
  by verified version args. Apt packages are not pinned: they are whatever the
  enabled repositories served at build time.
